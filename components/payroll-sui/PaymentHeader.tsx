...
import { LogOut, ClipboardList, Menu, X as CloseIcon } from "lucide-react"; // Import icons
import TransactionsLog from "./TransactionsLog";
import QuickActions from "./QuickActions";
import { useAuth } from "@/context/authContext";
import { StyledConnectButton } from "./ConnectWallet";

// Update interface to include token props
...
const PaymentsHeader: React.FC<PaymentsHeaderProps> = ({
  ...
  return (
    ...
    <div className="mb-6 sm:mb-8 px-4 md:px-6 lg:px-8 w-full">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center space-y-4 md:space-y-0 relative">
        ...
        <div className="hidden md:flex items-center space-x-3 lg:space-x-4">
          ...
          >
            ...
            <span className="hidden lg:inline font-medium text-sm whitespace-nowrap text-black dark:text-white">
              Logs
            </span>
          </motion.button>
          <motion.button
      ...
      {/* Modals */}
      <TransactionsLog isOpen={showLogs} onClose={() => setShowLogs(false)} />
